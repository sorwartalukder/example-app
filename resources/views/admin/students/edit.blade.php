            ...
            <div class="p-6 text-gray-900">
               <div class="container p-2 mx-auto sm:p-4">
                   <div class='flex justify-between items-center'>
                    <h2 class="mb-4 text-2xl font-semibold leading-tight">Update Student</h2>
                ...
                <fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-gray-900">
                    <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <select name="class_id" class="w-full text-slate-900">
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            name='name'
                             ...
                             class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 border-gray-700 text-gray-900 @error('name') is-invalid @enderror"
                             value="{{$student->name}}"
                             >
                             @error('name')
                             <span class=" text-red-600 invalid-feedback" role="alert">
                        ...
                        <div class="col-span-full sm:col-span-3">
                            <label>Roll <span class='text-red-500'>*</span></label>
                            <input type="text"
                            name='roll'
                             placeholder="Roll" 
                             class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 border-gray-700 text-gray-900 @error('roll') is-invalid @enderror"
                             value="{{$student->roll}}"
                             >
                             @error('roll')
                             <span class=" text-red-600 invalid-feedback" role="alert">
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            name='phone'
                             placeholder="Phone" 
                             class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 border-gray-700 text-gray-900 @error('phone') is-invalid @enderror"
                            value="{{$student->phone}}"
                             >
                             @error('phone')
                             <span class=" text-red-600 invalid-feedback" role="alert">
